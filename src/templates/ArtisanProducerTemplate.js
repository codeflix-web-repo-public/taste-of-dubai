...
const ArtisanProducerTemplate = (props) =>  {
    const data = props.data.wpArtisanproducer
...
export const artisanProducerQuery = graphql`
query($id: String!) {
    wpArtisanproducer(id: {eq: $id}) {
        id
        title
        uri
        seo {
        ...
        ...artisanProducerTemplateQuery
    }
}
`

export default ArtisanProducerTemplate